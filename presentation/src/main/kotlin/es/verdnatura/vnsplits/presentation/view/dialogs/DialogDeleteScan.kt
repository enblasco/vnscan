 ...
 */
class DialogDeleteScan {

    val dialog : AlertDialog.Builder

    constructor(context: Context, delete: () -> Unit){
        dialog = AlertDialog.Builder(context)
        dialog.setTitle(UtilsResources.getResourceString(context, R.string.delete_scan_title))
        dialog.setMessage(UtilsResources.getResourceString(context, R.string.delete_scan_message))
